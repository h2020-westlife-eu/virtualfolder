...
(function(e) {
    ...
    e.onmessage = function(r) {
        ...
        if (i.command) {
            ...
            initBaseUrls(i.tlns), acequire("ace/lib/es5-shim"), n = e.sender = initSender();
...
ace.define('ace/worker/provn',["require","exports","module","ace/lib/oop","ace/worker/mirror"], function(acequire, exports, module) {
  "use strict";
