...
echo -e "BOOTSTRAP FINISHED, VM prepared to use\n 'vagrant' and 'vagrant_data' providers registered for Virtual Folder services.\nTo access VF services launch browser at http://localhost:8080/"
