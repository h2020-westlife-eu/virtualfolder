...
sudo -i -u vagrant export MPI_LIBDIR=/usr/lib/openmpi/lib;export MPI_INCLUDE=/usr/lib/openmpi/include;export MPI_BINDIR=/usr/bin;/home/vagrant/scipion/scipion config
