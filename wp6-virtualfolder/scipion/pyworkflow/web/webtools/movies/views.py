...
def create_movies_project(request):
    if request.is_ajax():
        ...
        # tomas westlife workaround path @todo: this path to uploads dir should be configurable outside the code...
        source = "/home/vagrant/ScipionUserData/services/scipion/data/uploads/" + projectName
