...
define('pdbcomponents/dataset',['exports'], function (exports) {
  'use strict';
  ...
  var Dataset = exports.Dataset = (_temp = _class = function () {
    ...
    Dataset.prototype.bootstrapPdbeAutocomplete = function bootstrapPdbeAutocomplete() {
      var event;
...
define('pdbcomponents/pdb-id',['exports', 'aurelia-framework'], function (exports, _aureliaFramework) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.PdbIdCustomAttribute = undefined;
  ...
  var PdbIdCustomAttribute = exports.PdbIdCustomAttribute = (_class = (_temp = _class2 = function () {
    ...
    PdbIdCustomAttribute.prototype.bind = function bind(o1, o2) {
      console.log('bind()');
      console.log(o1);
      this.value = o1.item;
      console.log(o2);
  ...
  }(), _class2.inject = [Element], _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'value', [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
  })), _class);
});
define('pdbcomponents/pdb-ids',['exports'], function (exports) {
  ...
  var PdbsIdCustomAttribute = exports.PdbsIdCustomAttribute = (_temp = _class = function () {
    function PdbsIdCustomAttribute(element) {
      _classCallCheck(this, PdbsIdCustomAttribute);

      this.element = element;
    }

    PdbsIdCustomAttribute.prototype.bind = function bind() {
      console.log(this.value);
      angular.bootstrap(this.element, ['pdb.component.library']);
    };

    return PdbsIdCustomAttribute;
  }(), _class.inject = [Element], _temp);
});
define('pdbcomponents/renderpdbs',["exports"], function (exports) {
  "use strict";
  ...
  var RenderpdbsCustomAttribute = exports.RenderpdbsCustomAttribute = (_temp = _class = function () {
    function RenderpdbsCustomAttribute(element) {
      _classCallCheck(this, RenderpdbsCustomAttribute);

      this.element = element;
      this.pdbdataitem = "";
    }

    RenderpdbsCustomAttribute.prototype.bind = function bind() {
      this.pdbdataitem = this.value;

      var htmlpdbitem = "<a class='pdb-links' href='javascript:void(0);' pdb-id='" + this.pdbdataitem + "' >" + this.pdbdataitem + "</a>";

      this.element.insertAdjacentHTML('beforeend', htmlpdbitem);
      angular.bootstrap(this.element, ['pdb.component.library']);
    };

    RenderpdbsCustomAttribute.prototype.attached = function attached() {};

    return RenderpdbsCustomAttribute;
  }(), _class.inject = [Element], _temp);
});
...
define('text!pdbcomponents/dataset.html', ['module'], function(module) { module.exports = "<template>\n  <require from=\"./renderpdbs\"></require>\n  <require from=\"./pdb-id\"></require>\n  <require from=\"./pdb-ids\"></require>\n<div class=\"w3-card w3-pale-blue\">\n\n  <h1>Dataset demo</h1>\n  <form>\n    <input value.bind=\"pdbdataitem\" change.trigger=\"additem()\"/>\n  </form>\n  <pdb-autocomplete-search></pdb-autocomplete-search>\n  <ul>\n    <li repeat.for=\"item of pdbdataset\">${item}\n      <div id=\"pdblinks-${item}\">\n        PDB link:<a href=\"\" class='pdb-links' pdb-id.bind=\"${item}\">${item}</a>\n        PDB link:<a href=\"\" class='pdb-links' pdb-id.bind=\"item\">${item}</a>\n        PDB Redo:<pdb-redo pdb-id=\"value.bind: item\"></pdb-redo>\n        PDB Residue interaction: <pdb-residue-interactions pdb-id=\"value.bind: item\"></pdb-residue-interactions>\n        PDB 3D complex: <pdb-3d-complex pdb-id=\"value.bind: item\" assembly-id=\"1\"></pdb-3d-complex>\n      </div>\n      <div renderpdbs></div>\n    </li>\n  </ul>\n  <pdb-prints pdb-ids=\"${pdbdataset}\" settings='{\"size\": 48 }'></pdb-prints>\n</div>\n</template>\n"; });
