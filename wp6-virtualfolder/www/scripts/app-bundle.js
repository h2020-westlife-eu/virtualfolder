...
define('filemanager2/panel',['exports', 'aurelia-event-aggregator', '../filepicker/messages', '../tabs/messages', 'aurelia-framework'], function (exports, _aureliaEventAggregator, _messages, _messages2, _aureliaFramework) {
    ...
    var Panel = exports.Panel = (_temp = _class = function () {
        function Panel(ea) {
            ...
            this.ids = [this.uid + '.list', this.uid + '.view', this.uid + '.visual'];

            this.selectedTab = this.ids[0];
            this.paneltabs = [{ id: this.ids[0], label: 'File List' }, { id: this.ids[1], label: 'RAW File View' }, { id: this.ids[2], label: 'Visualize' }];
...
define('filemanager2/viewpanel',['exports', 'aurelia-event-aggregator', '../filepicker/messages', 'aurelia-http-client', 'aurelia-framework'], function (exports, _aureliaEventAggregator, _messages, _aureliaHttpClient, _aureliaFramework) {
  'use strict';
