...
define('filepicker/filepanel',['exports', 'aurelia-http-client', 'aurelia-event-aggregator', './messages', 'aurelia-framework', 'whatwg-fetch'], function (exports, _aureliaHttpClient, _aureliaEventAggregator, _messages, _aureliaFramework) {
  ...
  var Filepanel = exports.Filepanel = (_class = (_temp = _class2 = function () {
    function Filepanel(ea, httpclient) {
      ...
      if (localStorage && localStorage.filepanel) this.path = "";
...
define('pdbcomponents/dataset',['exports', 'aurelia-http-client', 'aurelia-framework', 'aurelia-event-aggregator', '../filepicker/messages', 'whatwg-fetch'], function (exports, _aureliaHttpClient, _aureliaFramework, _aureliaEventAggregator, _messages) {
  'use strict';
...
define('virtualfoldersetting/genericcontrol',['exports', 'aurelia-fetch-client', 'aurelia-framework', 'aurelia-event-aggregator', './messages', './dropboxcontrol'], function (exports, _aureliaFetchClient, _aureliaFramework, _aureliaEventAggregator, _messages, _dropboxcontrol) {
  ...
  var Genericcontrol = exports.Genericcontrol = (_dec = (0, _aureliaFramework.computedFrom)('selectedProvider'), _dec2 = (0, _aureliaFramework.computedFrom)('selectedProvider'), _dec3 = (0, _aureliaFramework.computedFrom)('selectedProvider'), _dec4 = (0, _aureliaFramework.computedFrom)('selectedProvider'), (_class = (_temp = _class2 = function () {
    ...
    Genericcontrol.prototype.attached = function attached() {
      ...
      this.client.fetch("/metadataservice/" + this.providerspath, { headers: this.myHeaders, credentials: 'include' }).then(function (response) {
        return response.json();
      }).then(function (data) {
        if (data) {
    ...
    Genericcontrol.prototype.checkWebdav = function checkWebdav(url, settings) {
      ...
      this.client.fetch(url, { method: 'HEAD', credentials: 'include' }).catch(function (error) {
