...
define('virtualfoldersetting/importprovider',['exports', 'aurelia-http-client', 'aurelia-event-aggregator', './messages', '../utils/vfstorage', '../behavior', '../pdbcomponents/dataitem'], function (exports, _aureliaHttpClient, _aureliaEventAggregator, _messages, _vfstorage, _behavior, _dataitem) {
  'use strict';
...
define('pages/fmsettings',['exports', 'aurelia-framework', 'aurelia-dialog', '../utils/vfstorage'], function (exports, _aureliaFramework, _aureliaDialog, _vfstorage) {
  'use strict';
...
define('pages/fmsettings2',['exports', 'aurelia-framework', 'aurelia-dialog', '../utils/vfstorage'], function (exports, _aureliaFramework, _aureliaDialog, _vfstorage) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Prompt2 = undefined;
  ...
  var Prompt2 = exports.Prompt2 = (_dec = (0, _aureliaFramework.inject)(_aureliaDialog.DialogController), _dec(_class = function () {
    function Prompt2(controller) {
    ...
    Prompt2.prototype.activate = function activate(message) {
    ...
    Prompt2.prototype.close = function close() {
      if (typeof Storage !== "undefined") {
        _vfstorage.Vfstorage.setValue("visualizepdb", this.visualizepdb);
        _vfstorage.Vfstorage.setValue("visualizeimg", this.visualizeimg);
      }
    ...
    Prompt2.prototype.log = function log(method) {
      console.log("Fmsettings." + method + "(), visualizepdb, visualizeimg");
      console.log(this.visualizepdb);
      console.log(localStorage.getItem("visualizepdb"));
      console.log(this.visualizeimg);
