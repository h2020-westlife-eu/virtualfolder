define('app',['exports'], function (exports) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: ['', 'dashboard'], name: 'dashboard', moduleId: 'pages/virtualfolderhome', nav: true, title: 'Dashboard' }, { route: 'setting', name: 'setting', moduleId: 'pages/virtualfolderhome', nav: true, title: 'Setting' }, { route: 'filemanager', name: 'filemanager', moduleId: 'pages/virtualfolderhome', nav: true, title: 'File Manager' }, { route: 'filepicker', name: 'filepicker', moduleId: 'pages/virtualfolderhome', nav: true, title: 'File Picker' }]);
      this.router = router;
    };
...
define('pages/virtualfolderhome',['exports', 'aurelia-http-client', 'aurelia-event-aggregator', '../behavior'], function (exports, _aureliaHttpClient, _aureliaEventAggregator, _behavior) {
  'use strict';
...
define('syncsetting/app',['exports', 'aurelia-event-aggregator', '../behavior', 'aurelia-http-client', '../utils/vfstorage'], function (exports, _aureliaEventAggregator, _behavior, _aureliaHttpClient, _vfstorage) {
  ...
  var App = exports.App = (_temp = _class = function () {
    ...
    App.prototype.includeSettings = function includeSettings(provider) {
      provider.selected = true;
    };

    App.prototype.notincludeSettings = function notincludeSettings(provider) {
...
define('components/navigation',["exports", "./projectapi"], function (exports, _projectapi) {
  "use strict";
  ...
  var Navigation = exports.Navigation = (_temp = _class = function () {
    function Navigation(projectapi) {
