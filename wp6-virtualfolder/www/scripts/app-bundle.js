...
define('components/projectapi',["exports", "aurelia-fetch-client", "../utils/vfstorage"], function (exports, _aureliaFetchClient, _vfstorage) {
  ...
  var ProjectApi = exports.ProjectApi = (_temp = _class = function () {
    ...
    ProjectApi.prototype.getExportedSettings = function getExportedSettings(publickey, selectedaliases) {
      var queryurl = new URL(this.settingsurl, window.location.href);
...
define('editor/fileeditor',["exports", "codemirror", "aurelia-event-aggregator", "aurelia-fetch-client", "../filepicker/messages", "aurelia-framework", "../utils/vfstorage", "codemirror/mode/clike/clike", "codemirror/mode/htmlmixed/htmlmixed", "codemirror/mode/javascript/javascript"], function (exports, _codemirror, _aureliaEventAggregator, _aureliaFetchClient, _messages, _aureliaFramework, _vfstorage) {
  ...
  var Fileeditor = exports.Fileeditor = (_class = (_temp = _class2 = function () {
    ...
    Fileeditor.prototype.attached = function attached() {
      ...
      this.subscription = this.ea.subscribe(_messages.EditFile, function (msg) {
    ...
    Fileeditor.prototype.detached = function detached() {
...
define('filemanager2/panel',['exports', 'aurelia-event-aggregator', '../filepicker/messages', '../tabs/messages', 'aurelia-framework'], function (exports, _aureliaEventAggregator, _messages, _messages2, _aureliaFramework) {
  ...
  var Panel = exports.Panel = (_class = (_temp = _class2 = function () {
    ...
    Panel.prototype.attached = function attached() {
      var _this = this;

      this.s1 = this.ea.subscribe(_messages.SelectedFile, function (msg) {
        return _this.selectFile(msg.file, msg.senderid);
      });
      this.s2 = this.ea.subscribe(_messages2.SelectedTab, function (msg) {
        return _this.selectTab(msg.tabid);
      });
    };

    Panel.prototype.detached = function detached() {
      this.s1.dispose();
      this.s2.dispose();
    };
...
define('filepicker/filepanel',['exports', '../components/projectapi', 'aurelia-event-aggregator', './messages', '../behavior', 'aurelia-framework', '../utils/vfstorage', './pdbresource', './uniprotresource', 'whatwg-fetch'], function (exports, _projectapi, _aureliaEventAggregator, _messages, _behavior, _aureliaFramework, _vfstorage, _pdbresource, _uniprotresource) {
  ...
  var Filepanel = exports.Filepanel = (_class = (_temp = _class2 = function () {
    ...
    Filepanel.prototype.addUpDir = function addUpDir() {
      this.files.unshift({ name: "..", nicesize: "UP-DIR", date: "", available: true, isdir: true });
    };
    ...
    Filepanel.prototype.populateFiles = function populateFiles(dataresponse) {
      ...
      this.files.forEach(function (item, index, arr) {
        ...
        if (arr[index].attributes & 16) {
          arr[index].nicesize = "DIR";arr[index].isdir = true;
        } else {
...
define('pdbcomponents/dataset',['exports', '../components/projectapi', 'aurelia-framework', 'aurelia-event-aggregator', '../filepicker/messages', '../utils/vfstorage', 'whatwg-fetch'], function (exports, _projectapi, _aureliaFramework, _aureliaEventAggregator, _messages, _vfstorage) {
  ...
  var Dataset = exports.Dataset = (_class = (_temp = _class2 = function () {
    ...
    Dataset.prototype.attached = function attached() {
      ...
      this.s1 = this.ea.subscribe(_messages.DatasetFile, function (msg) {
    ...
    Dataset.prototype.detached = function detached() {
      this.s1.dispose();
    };
    ...
    Dataset.prototype.submit = function submit() {
      ...
      this.pa.addDataset("/" + this.id, this.submitdataset).then(function (data) {
        ...
        if (_this3.id === 0) _this3.datasetlist.push({ Id: data.Id, Name: data.Name });
        _this3.showlist = true;
      }).catch(function (error) {
...
define('pdbcomponents/viewpanel',['exports', 'aurelia-event-aggregator', '../filepicker/messages', 'aurelia-framework'], function (exports, _aureliaEventAggregator, _messages, _aureliaFramework) {
  ...
  var Viewpanel = exports.Viewpanel = (_class = (_temp = _class2 = function () {
    ...
    Viewpanel.prototype.attached = function attached() {
      ...
      this.s1 = this.ea.subscribe(_messages.VisualizeFile, function (msg) {
    ...
    Viewpanel.prototype.detached = function detached() {
      this.s1.dispose();
    };
...
define('resources/index',['exports'], function (exports) {
  ...
  function configure(config) {
    config.globalResources(['./irep.html', './irepdemo.html', './iadmin.html', './istaff.html', './ifile.html', './ilink.html', './ilinkfolder.html', './icopy', './ifolder.html', './idata.html', './iproject.html', './itable.html', './ispincog.html', './idelete.html', './inext.html', './icopyicon.html', './icogs.html']);
  }
});
define('syncsetting/app',['exports', 'aurelia-event-aggregator', '../behavior', '../components/projectapi', '../utils/vfstorage'], function (exports, _aureliaEventAggregator, _behavior, _projectapi, _vfstorage) {
  ...
  var App = exports.App = (_temp = _class = function () {
    ...
    App.prototype.attached = function attached() {
      ...
      this.s1 = this.ea.subscribe(_behavior.HandleLogin, function (msg) {
        return _this.handler.handlelogin();
      });
      this.s2 = this.ea.subscribe(_behavior.MayLogout, function (msg) {
        return _this.handler.maylogout();
      });
      ...
      this.pa.getFiles().then(function (data) {
        ...
        _this.providers = data.map(function (x) {
...
define('tabs/tabs',['exports', 'aurelia-framework', 'aurelia-event-aggregator', './messages', '../filepicker/messages'], function (exports, _aureliaFramework, _aureliaEventAggregator, _messages, _messages2) {
  ...
  var Tabs = exports.Tabs = (_class = (_temp = _class2 = function () {
    ...
    Tabs.prototype.attached = function attached() {
      ...
      this.s1 = this.ea.subscribe(_messages2.VisualizeFile, function (msg) {
        return _this.selectVisualize(msg.file, msg.senderid);
      });
      this.s2 = this.ea.subscribe(_messages2.EditFile, function (msg) {
        return _this.selectEdit(msg.file, msg.senderid);
      });
    };

    Tabs.prototype.detached = function detached() {
      this.s1.dispose();
      this.s2.dispose();
    };
...
define('virtualfoldersetting/aliastable',['exports', '../components/projectapi', 'aurelia-event-aggregator', './messages', '../utils/vfstorage', '../behavior', '../pdbcomponents/dataitem'], function (exports, _projectapi, _aureliaEventAggregator, _messages, _vfstorage, _behavior, _dataitem) {
  ...
  var Aliastable = exports.Aliastable = (_temp = _class = function () {
    ...
    Aliastable.prototype.attached = function attached() {
      ...
      this.s1 = this.ea.subscribe(_messages.SettingsSubmitted, function (msg) {
...
define('virtualfoldersetting/genericcontrol',['exports', '../components/projectapi', 'aurelia-framework', 'aurelia-event-aggregator', './messages', './dropboxcontrol', '../utils/vfstorage', '../pdbcomponents/dataitem'], function (exports, _projectapi, _aureliaFramework, _aureliaEventAggregator, _messages, _dropboxcontrol, _vfstorage, _dataitem) {
  ...
  var Genericcontrol = exports.Genericcontrol = (_dec = (0, _aureliaFramework.computedFrom)('selectedProvider'), _dec2 = (0, _aureliaFramework.computedFrom)('selectedProvider'), _dec3 = (0, _aureliaFramework.computedFrom)('selectedProvider'), _dec4 = (0, _aureliaFramework.computedFrom)('selectedProvider'), _dec5 = (0, _aureliaFramework.computedFrom)('selectedProvider'), (_class = (_temp = _class2 = function () {
    ...
    Genericcontrol.prototype.attached = function attached() {
      ...
      this.s1 = this.ea.subscribe(_messages.SettingsSelected, function (msg) {
    ...
    Genericcontrol.prototype.detached = function detached() {
      this.s1.dispose();
    };
    ...
    Genericcontrol.prototype.addProvider = function addProvider() {
      ...
      this.pa.putProvider(settings).then(function (data) {
        _this2.ea.publish(new _messages.SettingsSubmitted(data));
        _this2.clear();
      }).catch(function (error) {
        console.log(error);
        alert('Sorry. Settings not submitted  at ' + _this2.serviceurl + ' error:' + error.response + " status:" + error.statusText);
      });
      return true;
    };
  ...
  }(), _class2.inject = [_aureliaEventAggregator.EventAggregator, _projectapi.ProjectApi, _dropboxcontrol.DropboxControl], _temp), (_applyDecoratedDescriptor(_class.prototype, 'selectedDropbox', [_dec], Object.getOwnPropertyDescriptor(_class.prototype, 'selectedDropbox'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'selectedB2Drop', [_dec2], Object.getOwnPropertyDescriptor(_class.prototype, 'selectedB2Drop'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'selectedFileSystem', [_dec3], Object.getOwnPropertyDescriptor(_class.prototype, 'selectedFileSystem'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'selectedWebDav', [_dec4], Object.getOwnPropertyDescriptor(_class.prototype, 'selectedWebDav'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'selectedOnedata', [_dec5], Object.getOwnPropertyDescriptor(_class.prototype, 'selectedOnedata'), _class.prototype)), _class));
});
...
define('virtualfoldersetting/storageprovider',['exports', 'aurelia-event-aggregator', './messages'], function (exports, _aureliaEventAggregator, _messages) {
  ...
  var Storageprovider = exports.Storageprovider = (_temp = _class = function () {
    ...
    Storageprovider.prototype.attached = function attached() {
      var _this = this;

      this.s1 = this.ea.subscribe(_messages.SettingsSubmitted, function (msg) {
        return _this.submitSettings(msg.settings);
      });
      this.s2 = this.ea.subscribe(_messages.SettingsSelected, function (msg) {
        return _this.selectSettings(msg.settings);
      });
    };

    Storageprovider.prototype.detached = function detached() {
      this.s1.dispose();
      this.s2.dispose();
    };
...
define('text!resources/ilinkfolder.html', ['module'], function(module) { module.exports = "<template bindable=\"href\">\n  <a href.bind=\"href\" title=\"Go directly to the folder\"><i class=\"fa fa-arrow-right\"></i></a>\n</template>\n"; });
