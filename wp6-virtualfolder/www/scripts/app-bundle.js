  ...
  var Fileeditor = exports.Fileeditor = (_class = (_temp = _class2 = function () {
    ...
    Fileeditor.prototype.selectFile = function selectFile(file, senderid) {
      ...
      if (senderid != this.pid) {
        ...
        if (!this.isimage) this.client.get(file.webdavuri).then(function (data) {
...
define('text!tabs/tabs.html', ['module'], function(module) { module.exports = "<template>\n    <ul class=\"w3-navbar\">\n        <li repeat.for=\"tab of tabs\">\n            <a class=\"w3-padding-tiny w3-small w3-hover-blue\" class.bind=\"tab.active ? 'w3-pale-blue': 'w3-grey'\" href=\"javascript:void(0)\" click.delegate=\"opentab(tab)\">${tab.label}</a>\n        </li>\n    </ul>\n</template>\n"; });
...
define('text!virtualfoldersetting/taskcontrol.html', ['module'], function(module) { module.exports = "<template>\n  <div class=\"w3-sand w3-padding\">\n\n    <table class=\"w3-sand \">\n      <thead>\n      <tr>\n        <th align=\"left\">Task</th>\n        <th align=\"left\">Description</th>\n        <th></th>\n      </tr>\n      </thead>\n      <tbody>\n      <tr class=\"w3-hover-green\" repeat.for=\"task of tasks\">\n        <td>${task.Name}</td><td>${task.Description}</td><td show.bind=\"!task.Updating\"><i class=\"fa fa-start\" click.delegate=\"starttask(task)\" show.bind=\"!task.Running\" title=\"not running - you may start it\"></i><i class=\"fa fa-stop\" click.delegate=\"stoptask(task)\"  show.bind=\"task.Running\" title=\"running - you may stop it\"></i></td><td show.bind=\"task.Updating\"><img src=\"img/vfloader.gif\"></td><td show.bind=\"task.Running\">access UI <a href.bind=\"task.LocalUrl\">${task.LocalUrl}</a></td>\n      </tr>\n      </tbody>\n    </table>\n\n  </div>\n</template>\n"; });
