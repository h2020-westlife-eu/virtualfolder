...
ace.define('ace/worker/prov-n-worker',["require","exports","module","ace/lib/oop","ace/worker/mirror"], function(require, exports, module) {
  "use strict";
...
var validate = function(input) {
  return [ { row: 0, column: 0, text: "Prov-N says Hello!", type: "error" } ];
};
